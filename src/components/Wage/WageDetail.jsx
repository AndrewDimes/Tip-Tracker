      ...
      <div class="ui middle aligned divided list">
        <div class="item">
          <div class="right floated content">
            <div style={{ color: 'white' }}>
              {' '}
              {wageData.mondayAvg ? wageData.mondayAvg.toFixed(2) : '0.00'}{' '}
            </div>
          </div>
          <div class="left floated content" style={{ color: 'white' }}>
            Mondays{' '}
          ...
          <div class="right floated content">
            <div style={{ color: 'white' }}>
              ...
              {wageData.wednesdayAvg
                ? wageData.wednesdayAvg.toFixed(2)
                : '0.00'}{' '}
            </div>
          </div>
          <div class="left floated content" style={{ color: 'white' }}>
          ...
          <div class="right floated content">
            <div style={{ color: 'white' }}>
              ...
              {wageData.thursdayAvg
                ? wageData.thursdayAvg.toFixed(2)
                : '0.00'}{' '}
            </div>
          </div>
          <div class="left floated content" style={{ color: 'white' }}>
        ...
        <div class="item">
          <div class="right floated content">
            <div style={{ color: 'white' }}>
              {' '}
              {wageData.fridayAvg ? wageData.fridayAvg.toFixed(2) : '0.00'}
            </div>
          </div>
          <div class="left floated content" style={{ color: 'white' }}>
            {' '}
        ...
        <div class="item">
          <div class="right floated content">
            <div style={{ color: 'white' }}>
              {' '}
              {wageData.saturdayAvg ? wageData.saturdayAvg.toFixed(2) : '0.00'}
            </div>
          </div>
          <div class="left floated content" style={{ color: 'white' }}>
            {' '}
        ...
        <div class="item">
          <div class="right floated content">
            <div style={{ color: 'white' }}>
              {' '}
              {wageData.sundayAvg ? wageData.sundayAvg.toFixed(2) : '0.00'}
            </div>
          </div>
          <div class="left floated content" style={{ color: 'white' }}>
            {' '}
